...
/*
    ...
    context构成简单的environments链, 从而构成作用域!
...
public class Compiler {
    ...
    public static List<Stmt> Parse(String source) throws Exception{
        return new Parser(source).parse();
    }

    public static List<ByteCode> ByteCodes(String source) throws Exception{
    ...
    public static void RunVM(String source) throws Exception{
